  ...
  return (
    <BackgroundLines className="relative flex items-center justify-center w-full flex-col px-4">
      <div className="absolute top-4 right-4 flex gap-4">
        ...
        <ScrollLink to="homeSection" smooth={true} duration={300}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="32"
            height="32"
            fill="currentColor"
            className="text-white cursor-pointer hover:scale-110 transition-transform duration-200 mr-10"
            viewBox="0 0 16 16"
          >
        ...
        <ScrollLink to="uploadSection" smooth={true} duration={300}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="32"
            height="32"
      ...
      Smart scans, faster answers—because your brain deserves precision, not guesswork or medical maybes.
      </p>
    </BackgroundLines>
  );
}
